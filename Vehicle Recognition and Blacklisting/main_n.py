...
def createi():
    ...
    add_Button = Button(selectframe, text = "Add",command=lambda :pro(lis[0][0]),height=1,font=myfont,anchor='w',relief=FLAT,bg="white").place(x=400, y=160)
...
def createv():
    ...
    mylistbox.bind('<<ListboxSelect>>',curselect)
    mylistbox.place(x=170,y=200)
    add_Button = Button(selectframe, text = "Add",command=lambda :prov(lis[0]),height=1,font=myfont,anchor='w',relief=FLAT,bg="white").place(x=400, y=160)
